...
- Forecasting
- R
description: "This is a personal, ongoing analysis of my recently diagnosed type-1
  diabetes. Data is integral to type-1 diabetes management, as carbohydrate estimations
  and insulin dosage calculations regularly occur throughout the day. Through this
  project, I aim to better understand my body and improve my type-1 diabetes management.
  Additionally, personal insights could translate into helping the greater diabetes
  community. This is the very beginning of a lifelong project."
---
...
<p>
A diabetic's blood glucose levels are directly affected by carbohydrates consumed, insulin taken, and exercise. There are additional contributing factors, but these are the variables I have measured and aggregated here in this analysis. Blood glucose levels are captured, via my CGM, every five minutes, meaning it is a time-series. With the transformations I have made to the remaining pertinent variables, the entirety of the data is a time-series. This naturally leads to time-series analysis and forecast modeling. Additionally, when considering the assumptions that predicate linear regression analysis (linearity, normality, homoscedasticity, and independence of variables), it is clear that linear regression will lead to unreliable analysis. In particular, due to the time-series nature of blood glucose levels, and effective carbs and insulin, there is an inherent autocorrelation, as all observations are based on prior observations. Furthermore, there is no discernible linear relationship between blood glucose levels and effective carbs, as blood glucose levels are always a positive value, while effective carbs levels are routinely zero between meals. Therefore, I will proceed directly to timeseries analysis and forecast modeling.
</p>
